...
# Title
st.markdown('<div class="main-title">🩺 Health Insurance Premium Prediction</div>', unsafe_allow_html=True)

st.markdown('<div class="info-text">Please fill in your details below to predict the premium.</div>', unsafe_allow_html=True)
st.markdown("---")
...
with row1[1]:
    number_of_dependents = st.number_input("Number of Dependents", min_value=0, max_value=5, step=1)
with row1[2]:
